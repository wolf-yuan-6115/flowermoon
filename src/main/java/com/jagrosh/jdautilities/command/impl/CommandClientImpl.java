...
/**
 * An implementation of {@link com.jagrosh.jdautilities.command.CommandClient
 * CommandClient} to be used by a bot.
 * 
 * <p>
 * This is a listener usable with {@link net.dv8tion.jda.api.JDA JDA}, as it
 * implements
 * {@link net.dv8tion.jda.api.hooks.EventListener EventListener} in order to
 * catch and use different kinds of
 * {@link net.dv8tion.jda.api.events.Event Event}s. The primary usage of this is
 * where the CommandClient implementation
 * takes {@link net.dv8tion.jda.api.events.message.MessageReceivedEvent
 * MessageReceivedEvent}s, and automatically
 * processes arguments, and provide them to a
 * {@link com.jagrosh.jdautilities.command.Command Command} for
...
public class CommandClientImpl implements CommandClient, EventListener {
    ...
    public CommandClientImpl(String ownerId, String[] coOwnerIds, String prefix, String altprefix, Activity activity,
            OnlineStatus status, String serverInvite,
            String success, String warning, String error, String carbonKey, String botsKey, ArrayList<Command> commands,
            boolean useHelp, boolean shutdownAutomatically, Consumer<CommandEvent> helpConsumer, String helpWord,
