...
public class AboutCommand extends Command {
    ...
    protected void execute(CommandEvent event) {
        ...
        StringBuilder descr = (new StringBuilder()).append("你好! 我是 **").append(event.getSelfUser().getName()).append("**, ").append(this.description).append("\nI ").append(this.IS_AUTHOR ? "使用Java寫成" : "的擁有者是").append(" **").append(author).append("** 正在使用 Chew 的 [指令擴充](https://github.com/Chew/JDA-Chewtils) (").append(JDAUtilitiesInfo.VERSION).append(") 以及 [JDA 程式庫](https://github.com/DV8FromTheWorld/JDA) (").append(JDAInfo.VERSION).append(")\n\n這個中文版本是由Wolf yuan翻譯，可以在 [這裡](https://github.com/wolf-yuan-6115/flowermoon) 下載\n輸入 `").append(event.getClient().getTextualPrefix()).append(event.getClient().getHelpWord())
